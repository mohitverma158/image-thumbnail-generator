...
class ThumbnailDownloader:
    ...
    def download_file(self):
        try:
            ...
            s3_file_name  ='Thumbnails/' + file_name
            download_file_name = 'Thubmnail' + file_name
            ...
            return {
                ...
                'headers': {
                    ...
                    'Content-Disposition': f'attachment; filename="{download_file_name}"',  # Downloads with updated file name
...
def lambda_handler(event, context):
    ...
    downloader = ThumbnailDownloader(event)
